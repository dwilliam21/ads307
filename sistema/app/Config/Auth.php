...
class Auth extends ShieldAuth
{
    ...
    public function loginRedirect(): string
    {
        ...
        }elseif (auth()->user()->inGroup('avaliador')){
            $url = auth()->user()->inGroup('avaliador') ? '/avaliador' : setting('Auth.redirects')['login'];
        }
        
        else{
            
            $url = auth()->user()->inGroup('user') ? '/aluno' : setting('Auth.redirects')['login'];
        }
    ...
    public function registerRedirect(): string
    {
        ...
        if (auth()->user()->inGroup('admin')){    
            ...
            $url = auth()->user()->inGroup('admin') ? '/admin' : setting('Auth.redirects')['register'];
        }elseif (auth()->user()->inGroup('avaliador')){
            $url = auth()->user()->inGroup('avaliador') ? '/avaliador' : setting('Auth.redirects')['register'];
        }
        
        else{
            
            $url = auth()->user()->inGroup('user') ? '/aluno' : setting('Auth.redirects')['register'];
        }
    ...
    public function groupDeniedRedirect(): string
    {
        ...
        if (auth()->user()->inGroup('admin')){    
            ...
            $url = auth()->user()->inGroup('admin') ? '/admin' : setting('Auth.redirects')['group_denied'];
        }elseif (auth()->user()->inGroup('avaliador')){
            $url = auth()->user()->inGroup('avaliador') ? '/avaliador' : setting('Auth.redirects')['group_denied'];
        }
        
        else{
            
            $url = auth()->user()->inGroup('user') ? '/aluno' : setting('Auth.redirects')['group_denied'];
        }
