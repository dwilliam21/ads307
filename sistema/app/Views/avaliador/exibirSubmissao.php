...
<div id="nav1010">
                ...
                <div class="container-fluid">
                    ...
                    <div class="offcanvas offcanvas-end text-bg-light" tabindex="-1" id="offcanvasDarkNavbar" aria-labelledby="offcanvasDarkNavbarLabel">
                        ...
                        <div class="offcanvas-body">
                            ...
                            <li class="nav-item">
                                <a class="nav-link " aria-current="page" href="<?= base_url("/index.php/avaliador")?>">Home</a>
                            </li>
                            <li class="nav-item dropdown">
                                    ...
                                    <li><a class="dropdown-item" href="<?= base_url("/index.php/avaliador/avaliacao")?>">Avaliação</a></li>
                                    <li><a class="dropdown-item" href="<?= base_url("/index.php/avaliador/exibirAvaliacao")?>">Exibir Avaliações</a></li>
                                </li>
                    </ul>
                    <li class="nav-item dropdown">
                                    <a class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-light">
                                    <li class="active"><a class="dropdown-item" href="<?= base_url("/index.php/avaliador/exibirSubmissao")?>">Exibir Projetos</a></li>
                                </li>
                    </ul>
                            </ul>
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav">
                    <li class="nav-item active">
                        <a class="nav-link" href="<?= base_url("/index.php/avaliador")?>">Home</a>
                    </li>
                    <li class="nav-item dropdown">
                                    <a class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                                    Avaliação
                    ...
                    <li class="nav-item dropdown">
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-light">
                                    <li><a class="dropdown-item" href="<?= base_url("/index.php/avaliador/exibirSubmissao")?>">Exibir Projetos</a></li>
                                </li>
                    </ul>
                </ul>
    ...
    <h1 class="d-flex justify-content-center">Lista de Pojetos</h1>
