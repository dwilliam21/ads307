...
<head>
            ...
            <nav class="navbar navbar-light bg-light sticky-top">
                <div class="container-fluid">
                    ...
                    <li class="nav-item dropdown">
                                ...
                                <li><a class="dropdown-item" href="#">Exibir Alunos</a></li>
                    </li>
                            </ul>
    ...
    <h1 align="center">Exibição de Alunos</h1>
    
    <div class="table-responsive">
        <table class="d-flex justify-content-center table table-bordered border-info ">
            <tr >
                <th>Id</th>
                <th>Matricula</th>
                <th>Nome</th>
